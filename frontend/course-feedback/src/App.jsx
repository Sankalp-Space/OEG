            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="px-4 py-2 bg-slate-600 hover:bg-slate-700 text-white rounded-lg font-medium transition-all duration-200 transform hover:scale-105"
                >
                  Admin Access
                </button>
                <button
                  onClick={() => setShowFeedback(true)}
                  className="px-4 py-2 bg-slate-600 hover:bg-slate-700 text-white rounded-lg font-medium transition-all duration-200 transform hover:scale-105 shadow-sm hover:shadow-md"
                >
                  Give Feedback
                </button>
              </div>
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
            ...
            <div className="bg-white border-b border-slate-200 p-8">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h1 className="text-3xl font-bold text-slate-900 mb-1">Oracle Fusion Lease Accounting</h1>
                  <p className="text-slate-600 text-lg">Advanced Course Module</p>
                </div>
              </div>
